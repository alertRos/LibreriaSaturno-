...
<div class="mt-12">
<h1 class="uppercase text-xl ml-2" style="color:rebeccapurple">Agregar autor</h1>
<div class="m-2">
    <section >
        <div class="grid grid-cols-3 u-gap-2" >
            <form action="agregar_autor.php" method="POST">
                ...
                <div class="form">
                    ...
                    <input type="tel" name="telefono" class="form-control" id="exampleInputPassword1" required>
                </div>
                <div class="form">
                ...
                <div class="form">
                    ...
                    <input type="text" name="ciudad" class="form-control" id="exampleInputPassword1" required>
                </div>
                <div class="form">
                ...
                <div class="form">
                    ...
                    <input type="number" min="10000" max="99999" name="cod-postal" class="form-control" id="exampleInputPassword1"  required>
                </div>
