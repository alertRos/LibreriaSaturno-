...
<div class="header header-fixed unselectable header-animated">
         ...
         <div class="header-nav" id="header-menu">
            ...
            <button class="btn-transparent"><a href="../web1/index.php">Libros</a></button>
               <button class="btn-transparent"><a href="index.php">Autores</a></button>
...
<div class="mt-10">
<div class="divider text-xl" data-content="Autores"></div>
<a href="agregar.php" class="utb utb-OLR text-lg ml-4 " style="color: black">+ Agregar autor</a>
<div class="m-4">
    <section >
        <div class="grid grid-cols-3 u-gap-2" >
            <?php
                include("enviar_autores.php");
                ?>
            </div>
    </section>
    </div>
